...
class AddAd extends JFrame implements ActionListener
{
	JTextField t1,t2;
	JLabel l1,l2,log,bg;
	JButton b1,b2;	
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		if(o.getLabel()=="ADD")
		{
			try
			{
				...
				int count=0;
				if((t1.getText()).equals("") || (t2.getText()).equals("") || 8<=(String.valueOf(t2.getText())).length())
				{
					count=1;
				}
				if(count==1)
				...
				{
					pstm1.executeUpdate();
					new Sdialog(this,"S U C C E S S F U L...",40,47,240,20,Color.GREEN,"Ok",190,87,89,25,590,350,295,130);
					t1.setText(" ");
					t2.setText(" ");
				}
			}
